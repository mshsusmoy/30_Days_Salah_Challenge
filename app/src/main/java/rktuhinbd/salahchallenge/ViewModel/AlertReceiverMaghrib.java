...
public class AlertReceiverMaghrib extends BroadcastReceiver {
    public static final String channelID = "channelID_Maghrib";
    @Override
...
//        notificationHelper.getManager().notify(4, nb.build());
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, 4, mIntent,PendingIntent.FLAG_UPDATE_CURRENT);
