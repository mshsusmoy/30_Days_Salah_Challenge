...
public class NotificationHelper_Maghrib extends ContextWrapper {
    public static final String channelID = "channelID";
    public static final String channelName = "Channel Name";

    private NotificationManager mManager;

    public NotificationHelper_Maghrib(Context base) {
        super(base);
...
//        context.startActivity(i);
    ...
    public NotificationCompat.Builder getChannelNotification() {
        ...
        PendingIntent pendingIntent_fajr =  PendingIntent.getActivity(getApplicationContext(),4,repeating_intent,PendingIntent.FLAG_UPDATE_CURRENT);
        return new NotificationCompat.Builder(getApplicationContext(), channelID)
                .setContentTitle("Salah Reminder!")
                .setContentText("Its time for Maghrib")
                .setAutoCancel(true)
