...
public class AlertReceiverAsr extends BroadcastReceiver {
    public static final String channelID = "channelID_Asr";
    @Override
...
//        notificationHelper.getManager().notify(3, nb.build());
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, 3, mIntent,PendingIntent.FLAG_UPDATE_CURRENT);
